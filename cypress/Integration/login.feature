Feature: Login
  ...
  Scenario: Login as a CEO
    Given I open the "http://dvl-test-frontend.s3-website-us-east-1.amazonaws.com"
    When I input "artem.vepryk@selectoglobal.com" into the "email_address_input" field
